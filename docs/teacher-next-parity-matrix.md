...
| --- | --- | --- | --- |
| Dashboard | `/teacher/` | Separated shell, partial-failure metric warning/retry, quick access, persisted sidebar, mobile drawer, conditional role switch, logout | No known functional gap; retain in final regression |
...
| My Report | `/teacher/report/` | Flutter-matching Reports navigation, month selection, overview KPIs, issues, classes/clock-ins/forms detail tabs, refresh, empty/error states, and CSV export | No known functional gap; retain in final regression |
