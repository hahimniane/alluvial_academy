...
void main() {
  group('TeachingShift Platform Tracking', () {
    ...
    group('toFirestore', () {
      test('non-teaching shifts omit subject fields and use duty names', () {
        final shift = testShift.copyWith(
          category: ShiftCategory.leadership,
          leaderRole: 'admin',
          subject: IslamicSubject.other,
          clearSubjectId: true,
          clearSubjectDisplayName: true,
          autoGeneratedName: TeachingShift.generateLeaderAutoName(
            leaderName: 'John Doe',
            category: ShiftCategory.leadership,
            leaderRole: 'admin',
          ),
        ...
        expect(data.containsKey('subject_id'), isFalse);
        expect(data.containsKey('subject_display_name'), isFalse);
        expect(shift.displayName, 'John Doe - Administration');
      });
