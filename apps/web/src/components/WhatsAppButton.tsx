...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className="whatsapp-fab group fixed bottom-4 right-4 z-40 flex items-center gap-2.5 rounded-full bg-[#25D366] py-3 pl-3.5 pr-4 text-white shadow-[0_16px_44px_rgba(37,211,102,0.42)] transition hover:-translate-y-0.5 hover:shadow-[0_20px_54px_rgba(37,211,102,0.5)]"
