...
// Schedules to create
const SCHEDULES = [
  // Boubacar Jalloh - IC / Islamic
  {
    studentCodes: ['boubacar.jalloh'],
    classType: 'IC',
    subject: 'islamic',
    subjectDisplay: 'Islamic',
    sessions: [
      { day: 2, startTime: '16:00', endTime: '17:00', durationMinutes: 60 }, // Tue 4-5 PM
      { day: 5, startTime: '16:00', endTime: '17:00', durationMinutes: 60 }, // Fri 4-5 PM
    ],
  },
  // Mariam Diallo - IC / Islamic
  {
    studentCodes: ['mariam.diallo'],
    classType: 'IC',
    subject: 'islamic',
    subjectDisplay: 'Islamic',
    sessions: [
      { day: 6, startTime: '14:15', endTime: '15:15', durationMinutes: 60 }, // Sat 2:15-3:15 PM
      { day: 7, startTime: '14:15', endTime: '15:15', durationMinutes: 60 }, // Sun 2:15-3:15 PM
    ],
  },
];
...
async function createShifts() {
  ...
  // 1. Find Ousman A Cham
  console.log('1. Finding teacher: Ousman A Cham...\n');
  ...
  for (const doc of teachersSnap.docs) {
    ...
    if (fullName.includes('ousman') && fullName.includes('cham')) {
      teacher = {
        uid: doc.id,
