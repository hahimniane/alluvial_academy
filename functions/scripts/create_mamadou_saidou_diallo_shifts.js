...
// Schedules to create
const SCHEDULES = [
  // Adama Diallo - IC / Islamic (individual)
  {
    studentCodes: ['adama.diallo'],
    classType: 'IC',
    subject: 'islamic',
    subjectDisplay: 'Islamic',
    sessions: [
      { day: 1, startTime: '19:00', endTime: '20:00', durationMinutes: 60 }, // Mon 7-8 PM
    ],
  },
  // FGC Group 1: Fatumata, Mamadou Samsy, Assata (group class)
  {
    studentCodes: ['fatumata.diallo', 'mamadousam.diallo', 'assata.diallo'],
    classType: 'FGC',
    subject: 'islamic',
    subjectDisplay: 'Islamic',
    sessions: [
      { day: 1, startTime: '17:30', endTime: '19:00', durationMinutes: 90 }, // Mon 5:30-7 PM
      { day: 2, startTime: '19:10', endTime: '20:40', durationMinutes: 90 }, // Tue 7:10-8:40 PM
      { day: 5, startTime: '19:10', endTime: '20:40', durationMinutes: 90 }, // Fri 7:10-8:40 PM (same as Tue)
      { day: 6, startTime: '09:30', endTime: '11:00', durationMinutes: 90 }, // Sat 9:30-11 AM
    ],
  },
  // FGC Group 2: Khadijah, Saidou, Mohammed Bah (group class)
  {
    studentCodes: ['khadijah.bah', 'saidou.bah', 'mohammed.bah'],
    classType: 'FGC',
    subject: 'islamic',
    subjectDisplay: 'Islamic',
    sessions: [
      { day: 5, startTime: '18:30', endTime: '20:00', durationMinutes: 90 }, // Fri 6:30-8 PM
      { day: 6, startTime: '18:30', endTime: '20:00', durationMinutes: 90 }, // Sat 6:30-8 PM
      { day: 7, startTime: '18:30', endTime: '20:00', durationMinutes: 90 }, // Sun 6:30-8 PM
    ],
  },
];
...
async function createShifts() {
  ...
  // 1. Find Mamadou Saidou Diallo
  console.log('1. Finding teacher: Mamadou Saidou Diallo...\n');
  ...
  for (const doc of teachersSnap.docs) {
    ...
    if (fullName.includes('mamadou') && fullName.includes('saidou') && fullName.includes('diallo')) {
      teacher = {
        uid: doc.id,
  ...
  if (!teacher) {
    ...
    for (const doc of teachersSnap.docs) {
      const data = doc.data();
      const fullName = `${data.first_name || ''} ${data.last_name || ''}`.trim().toLowerCase();
      if (fullName.includes('mamadou') || fullName.includes('saidou')) {
