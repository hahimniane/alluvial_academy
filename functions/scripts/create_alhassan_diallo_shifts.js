...
// Schedules to create
const SCHEDULES = [
  // Sadou Barry - IC / Islamic
  {
    studentCodes: ['1sadou.barry'],
    classType: 'IC',
    subject: 'islamic',
    subjectDisplay: 'Islamic',
    sessions: [
      { day: 6, startTime: '14:00', endTime: '15:00', durationMinutes: 60 }, // Sat 2-3 PM
      { day: 7, startTime: '14:00', endTime: '15:00', durationMinutes: 60 }, // Sun 2-3 PM
    ],
  },
  // Aissata Barry - IC / Islamic
  {
    studentCodes: ['1aissata.barry'],
    classType: 'IC',
    subject: 'islamic',
    subjectDisplay: 'Islamic',
    sessions: [
      { day: 6, startTime: '15:00', endTime: '16:00', durationMinutes: 60 }, // Sat 3-4 PM
      { day: 7, startTime: '15:00', endTime: '16:00', durationMinutes: 60 }, // Sun 3-4 PM
    ],
  },
  // Mamadou Saliou Diallo - IC / Islamic
  {
    studentCodes: ['mamadousal.diallo'],
    classType: 'IC',
    subject: 'islamic',
    subjectDisplay: 'Islamic',
    sessions: [
      { day: 5, startTime: '14:00', endTime: '15:00', durationMinutes: 60 }, // Fri 2-3 PM
      { day: 6, startTime: '13:00', endTime: '14:00', durationMinutes: 60 }, // Sat 1-2 PM
    ],
  },
];
...
async function createShifts() {
  ...
  // 1. Find Al-Hassan Diallo
  console.log('1. Finding teacher: Al-Hassan Diallo...\n');
  ...
  for (const doc of teachersSnap.docs) {
    ...
    if ((fullName.includes('al-hassan') || fullName.includes('alhassan') || fullName.includes('al hassan')) && fullName.includes('diallo')) {
      teacher = {
        uid: doc.id,
  ...
  if (!teacher) {
    ...
    for (const doc of teachersSnap.docs) {
      const data = doc.data();
      const fullName = `${data.first_name || ''} ${data.last_name || ''}`.trim().toLowerCase();
      if (fullName.includes('hassan') || fullName.includes('diallo')) {
