...
class TeachingShift {
  ...
  String get displayName {
    ...
    if (autoGeneratedName.isNotEmpty) return autoGeneratedName;
  ...
  static String generateLeaderAutoName({
    required String leaderName,
    required ShiftCategory category,
    String? leaderRole,
  }) {
    final normalizedRole = leaderRole?.trim().toLowerCase();
    final dutyName = switch (normalizedRole) {
      ...
      _ => switch (category) {
          ShiftCategory.meeting => 'Meeting',
          ShiftCategory.training => 'Staff Training',
          _ => 'Leader Duty',
        },
    };
    return leaderName.trim().isEmpty
        ? dutyName
        : '${leaderName.trim()} - $dutyName';
  }
  ...
  Map<String, dynamic> toFirestore() {
    return {
      ...
      if (category == ShiftCategory.teaching) 'subject': subject.name,
      if (category == ShiftCategory.teaching) 'subject_id': subjectId,
  ...
  factory TeachingShift.fromFirestore(DocumentSnapshot doc) {
    ...
    return TeachingShift(
      ...
      subject: IslamicSubject.values.firstWhere(
        ...
        orElse: () => category == ShiftCategory.teaching
            ? IslamicSubject.quranStudies
  ...
  TeachingShift copyWith({
    ...
    bool clearSubjectDisplayName = false,
    ...
    return TeachingShift(
      ...
      subjectDisplayName: clearSubjectDisplayName
          ? null
