...
class _CreateShiftDialogState extends State<CreateShiftDialog> {
  ...
  void _initializeFormData() {
    if (widget.shift != null) {
      ...
      if (shift.category == ShiftCategory.teaching && shift.subjectId != null) {
  ...
  Widget _buildStudentSelection() {
    ...
    final filteredStudents = _availableStudents.where((student) {
      ...
      return AppSearch.matches(
        query: _studentSearchController.text,
        names: [
        ...
        phones: [
          student.mobilePhone,
          '${student.countryCode}${student.mobilePhone}',
        ],
        ids: [
          student.documentId,
          student.studentCode,
    ...
    try {
      ...
      if (widget.shift == null) {
        ...
        await ShiftService.createShift(
          ...
          subject: _selectedCategory == ShiftCategory.teaching
              ? _mapSubjectToEnum(selectedSubject?.name ?? 'quran_studies')
              : IslamicSubject.other,
        ...
        final autoGeneratedName = _selectedCategory == ShiftCategory.teaching
            ? TeachingShift.generateAutoName(
                teacherName: teacherName,
                subject: _mapSubjectToEnum(
                  selectedSubject?.name ?? 'quran_studies',
                ),
                studentNames: studentNames,
              )
