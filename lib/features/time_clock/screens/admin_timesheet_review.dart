...
class _AdminTimesheetReviewState extends State<AdminTimesheetReview> {
  ...
  // Teacher data cache to avoid redundant Firestore calls
    ...
    try {
      ...
      if (teacherId != null && teacherId.isNotEmpty) {
        ...
        if (_teacherCache.containsKey(teacherId)) {
          userData = _teacherCache[teacherId];
        } else {
          try {
            ...
            if (userData != null) {
              _teacherCache[teacherId] = userData;
            }
          } catch (e) {
            AppLogger.debug(
                'Could not fetch user data for teacher_id $teacherId: $e');
      ...
      final userName = data['teacher_name'] as String? ??
          '${userData?['first_name'] ?? 'Unknown'} ${userData?['last_name'] ?? 'Teacher'}'
              .trim();
            ...
            if (shiftData != null) {
              ...
              if (finalScheduledDurationMinutes == null) {
                ...
                if (finalScheduledStart != null && finalScheduledEnd != null) {
                  finalScheduledDurationMinutes = finalScheduledEnd
                      .difference(finalScheduledStart)
                      .inMinutes;
                }
              }
            }
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        // Clock In
                        _buildComparisonRow(
                            'Clock In', originalStart, timesheet.start),
                        // Clock Out
                        _buildComparisonRow(
                            'Clock Out', originalEnd, timesheet.end),
                        // Total Hours
                        _buildComparisonRow(
