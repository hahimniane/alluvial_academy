                    ...
                    child: Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildSectionTitle('Zoom'),
                          const SizedBox(height: 16),
                          _buildNavigationTile(
                            title: 'Zoom Hosts',
                            subtitle: 'Manage licensed Zoom host accounts for concurrent meetings',
                            icon: Icons.video_call,
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(builder: (_) => const ZoomHostsScreen()),
                              );
                            },
                          ),
                          const SizedBox(height: 32),
  ...
  Widget _buildNavigationTile({
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon, color: const Color(0xff0386FF)),
