...
class _AdminAuditReviewScreenState extends State<AdminAuditReviewScreen> {
  ...
  Widget _wideLayout() {
    return Row(
      children: [
        SizedBox(
            width: 260,
            child: Container(color: Colors.white, child: _masterList())),
          ...
          child: _selectedAudit == null
              ...
              : AuditDetailFullPanel(
                  ...
                  onAuditChanged: (updated) =>
                      setState(() => _selectedAudit = updated),
          ...
          child: Row(
            children: [
              TextButton.icon(
                ...
                label:
                    Text(AppLocalizations.of(context)!.auditReviewBackToList),
              ),
            ],
          ),
        ),
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              Text(AppLocalizations.of(context)!.auditManagement,
                  style: GoogleFonts.inter(
              ...
              Row(
                children: [
                  ...
                  chip('pending',
                      AppLocalizations.of(context)!.auditStatusPending),
                  const SizedBox(width: 6),
                ...
                child: Container(
                  ...
                  child: Row(
                    children: [
                      CircleAvatar(
                        radius: 15,
                        backgroundColor: _tierColor(a.performanceTier)
                            .withValues(alpha: 0.12),
                        child: Text(
                          a.teacherName.isNotEmpty
                              ? a.teacherName[0].toUpperCase()
                              : '?',
                          style: GoogleFonts.inter(
                              fontSize: 11,
                              fontWeight: FontWeight.w700,
                              color: _tierColor(a.performanceTier)),
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                                '${_dept(a)} · ${a.overallScore.toStringAsFixed(0)}%',
                                style: GoogleFonts.inter(
                                    fontSize: 10,
  ...
  List<TeacherAuditFull> _filteredAudits() {
    ...
    final rows = widget.audits.where((a) {
      ...
      if (_filter == 'pending')
        return !(a.status == AuditStatus.completed ||
            a.status == AuditStatus.coachSubmitted);
      return a.status == AuditStatus.completed ||
          a.status == AuditStatus.coachSubmitted;
    }).toList()
